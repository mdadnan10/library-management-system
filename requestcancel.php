...
<body>
	  ...
	  <!--_________________________side navigation____________-->
              ...
              <div class="container">
               ...
               <br>
              <h3 style="text-align: center;">Sure Want to cancel The Request?</h3>
              <br><br>
              <form class="Approve" action="" method="post">
               <!-- <input class="form-control" type="text" name="approve" placeholder="Yes or No" required="">
                <input class="form-control" type="text" name="issue" placeholder="Issue Date dd-mm-yyyy" required="">
                <br>
                <input class="form-control" type="text" name="retorn" placeholder="Return Date dd-mm-yyyy" required="">
                <br><br>
                <div class="bt">-->
                <button class="btn btn-default" type="submit" name="submit">CANCEL</button>
              </form>
            </div>
          </div>
      </div>
      ...
      {
        mysqli_query($db," UPDATE `issuebook` SET `approve` = 'Denied', `issue` = '--', `retorn` = '--' WHERE username='$_SESSION[st_name]' AND bid='$_SESSION[bid]'");
